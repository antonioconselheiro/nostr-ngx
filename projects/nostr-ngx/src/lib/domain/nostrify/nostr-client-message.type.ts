...
export type NostrClientCOUNT = ['COUNT', subscriptionId: string, ...NostrFilter[]];
...
export type NostrClientMessage = NostrClientEVENT | NostrClientREQ | NostrClientCOUNT | NostrClientCLOSE | NostrClientAUTH;
